...
class ItemVariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_variant" do
    assert_difference("ItemVariant.count") do
      post item_variants_url, params: { item_variant: { cost: @item_variant.cost, currency: @item_variant.currency, image_index: @item_variant.image_index, item_id: @item_variant.item_id, name: @item_variant.name, price: @item_variant.price, store_id: @item_variant.store_id, value: @item_variant.value } }
    end
  ...
  test "should update item_variant" do
    patch item_variant_url(@item_variant), params: { item_variant: { cost: @item_variant.cost, currency: @item_variant.currency, image_index: @item_variant.image_index, item_id: @item_variant.item_id, name: @item_variant.name, price: @item_variant.price, store_id: @item_variant.store_id, value: @item_variant.value } }
