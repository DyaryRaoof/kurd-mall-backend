...
class OrderVariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_variant" do
    assert_difference("OrderVariant.count") do
      post order_variants_url, params: { order_variant: { item_variant_id: @order_variant.item_variant_id, order_id: @order_variant.order_id } }
    end
  ...
  test "should update order_variant" do
    patch order_variant_url(@order_variant), params: { order_variant: { item_variant_id: @order_variant.item_variant_id, order_id: @order_variant.order_id } }
