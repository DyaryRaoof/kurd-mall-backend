...
class ItemAnalyticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_analytic" do
    assert_difference("ItemAnalytic.count") do
      post item_analytics_url, params: { item_analytic: { item_id: @item_analytic.item_id, item_name: @item_analytic.item_name, lifetime_views: @item_analytic.lifetime_views, total_comments: @item_analytic.total_comments, total_item_sales: @item_analytic.total_item_sales, total_revenue_iqd: @item_analytic.total_revenue_iqd, total_revenue_usd: @item_analytic.total_revenue_usd, total_reviews: @item_analytic.total_reviews, total_shares: @item_analytic.total_shares, total_stars: @item_analytic.total_stars } }
    end
  ...
  test "should update item_analytic" do
    patch item_analytic_url(@item_analytic), params: { item_analytic: { item_id: @item_analytic.item_id, item_name: @item_analytic.item_name, lifetime_views: @item_analytic.lifetime_views, total_comments: @item_analytic.total_comments, total_item_sales: @item_analytic.total_item_sales, total_revenue_iqd: @item_analytic.total_revenue_iqd, total_revenue_usd: @item_analytic.total_revenue_usd, total_reviews: @item_analytic.total_reviews, total_shares: @item_analytic.total_shares, total_stars: @item_analytic.total_stars } }
