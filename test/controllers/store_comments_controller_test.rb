...
class StoreCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create store_comment' do
    assert_difference('StoreComment.count') do
      post store_comments_url,
           params: { store_comment: { description: @store_comment.description, store_id: @store_comment.store_id,
                                      user_id: @store_comment.user_id, user_name: @store_comment.user_name } }
    end
  ...
  test 'should update store_comment' do
    patch store_comment_url(@store_comment),
          params: { store_comment: { description: @store_comment.description, store_id: @store_comment.store_id,
                                     user_id: @store_comment.user_id, user_name: @store_comment.user_name } }
