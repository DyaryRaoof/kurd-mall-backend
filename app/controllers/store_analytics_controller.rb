  ...
  def create
    ...
    respond_to do |format|
      if @store_analytic.save
        format.html { redirect_to user_store_store_analytic_url(id: @store_analytic), notice: "Store analytic was successfully created." }
  ...
  def update
    respond_to do |format|
      if @store_analytic.update(store_analytic_params)
        format.html { redirect_to user_store_store_analytic_url(id: @store_analytic), notice: "Store analytic was successfully updated." }
