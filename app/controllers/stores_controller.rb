class StoresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @store.save
        format.html { redirect_to user_store_url(user_id: params[:user_id], id: @store.id), notice: "Store was successfully created." }
  ...
  private
    ...
    def store_params
      params.require(:store).permit(:user_id, :name, :description, :address, :phone, :instagram, :facebook, :locaation_long, :location_lat, :is_approved, :category_id, :subcategory_id, :city_id, images: [])
    end
end
