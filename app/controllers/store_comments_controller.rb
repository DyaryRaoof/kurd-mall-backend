  ...
  def create
    ...
    respond_to do |format|
      if @store_comment.save
        format.html { redirect_to user_store_store_comment_url(id: @store_comment), notice: "Store comment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @store_comment.update(store_comment_params)
        format.html { redirect_to user_store_store_comment_url(id: @store_comment), notice: "Store comment was successfully updated." }
